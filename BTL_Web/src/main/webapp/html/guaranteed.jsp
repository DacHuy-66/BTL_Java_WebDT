    ...
    <header>
        ...
        <div class="nav--mobile">
            ...
            <ul class="nav--infomation__mobile">
                <li class="tool">
                    <a href="./checkoder.html" class="menu--check__product" title="Kiểm tra bảo hành">
                        <i class="fa-solid fa-car"></i>
                    </a>
    ...
    <div class="container text-center mt-5">
        ...
        <form class="mt-3">
            <div class="form-group">
                <input type="text" class="form--control" id="orderID" placeholder="Vui lòng nhập mã bảo hành *">
            </div>
